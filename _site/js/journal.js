	...
	History.Adapter.bind(window,'statechange',function(){
		...
		$('.page-loader').load( state.hash + ' .page__content', function() {
			...
			setTimeout( function() {
				...
				var newFeaturedImageH = $('.page__content').attr('data-image-h');
				var newFeaturedImageW = $('.page__content').attr('data-image-w');
				...
				if ( newFeaturedImage !== featuredImage ) {
					...
					$('.header-image:not(.header-image--on)').css('background-position', newFeaturedImageW + '%' + newFeaturedImageH + '%');
